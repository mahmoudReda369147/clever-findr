      ...
      <section className="relative overflow-hidden py-20 sm:py-32">
        ...
        <div className="container relative mx-auto px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="mb-6 text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight animate-fade-in-up">
              Find the{" "}
            ...
            <p className="mb-12 text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto animate-fade-in-up">
            ...
            <div className="mb-8 animate-scale-in">
              <div className="relative max-w-2xl mx-auto">
                <div className="glass rounded-2xl p-2 hover-glow">
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      ...
                      <Input
                        ...
                        className="h-14 pl-12 pr-4 text-lg border-0 bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0"
                      />
                    </div>
                    <Button
                      size="icon"
                      variant="ghost"
                      className="h-14 w-14 rounded-xl hover:bg-accent/50"
                    >
                    ...
                    <Button
                      ...
                      size="lg"
                      className="h-14 px-8 rounded-xl hover-glow"
                    >
                      Search
                    </Button>
                  </div>
      ...
      <section className="py-20 border-t border-border/50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {/* Feature 1 */}
            <div className="glass rounded-2xl p-8 hover-glow transition-all hover:-translate-y-1">
              <div className="h-12 w-12 rounded-xl bg-primary/10 flex items-center justify-center mb-4">
                <TrendingUp className="h-6 w-6 text-primary" />
              </div>
              <h3 className="text-xl font-bold mb-2">Smart Comparison</h3>
